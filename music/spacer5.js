...
var myPlaylist = [
	{
		mp3:'music/checiny-1.mp3',
		oga:'music/checiny-1.ogg',
		title:'Chęciny - część 1/6',
		...
		rating:5,
		buy:'download05.php?src=checiny-1.mp3',
		price:'',
		duration:'7:28',
		cover:'music/2.jpg'	
	},
...
jQuery(document).ready(function ($) {
	$('.spacer5').ttwMusicPlayer(myPlaylist, {
		autoPlay:true,
		currencySymbol:'',
